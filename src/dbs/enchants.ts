...
const illusion17_1_armor = [15376, 15377];
const illusion17_1_garment = [20933, 20934];
const illusion17_1_shoes = [22196, 22197];
const illusion17_1_acc_right = [32207, 32209, 490309, 490310];
const illusion17_1_acc_left = [32208, 32210, 490309, 490310];
...
export const enchants: IBaseEquipment[] = [
  ...
  },
  {
    ...
    penetrationPercent: 0,
    canSelectOnSlot_3: {
      actives: [...headGearLab5, 20718, ...malangdo, ...racingCap, 18849],
    },
    canSelectOnSlot_4: {
  ...
  },
  {
    ...
    canSelectOnSlot_4: {
      actives: [2589, ...moraAtkSlot, 18849],
    },
    script: (character: Character2, _this: IBaseEquipment): void => {},
  },
  {
    ...
    canSelectOnSlot_4: {
      actives: [...malangdo, 2589, 15389, ...tempBoots, 490030, 18849],
    },
    script: (character: Character2, _this: IBaseEquipment): void => {},
  },
  {
  ...
  },
  {
    ...
    canSelectOnSlot_4: {
      actives: [...malangdo, ...tempBoots, 15389, 18849],
    },
    script: (character: Character2, _this: IBaseEquipment): void => {},
  },
  {
    ...
    canSelectOnSlot_4: {
      actives: [...malangdo, ...tempBoots, 15389, 2589, 490030, 18849],
    },
    script: (character: Character2, _this: IBaseEquipment): void => {},
  },
  {
  ...
  },
  {
    ...
    canSelectOnSlot_4: {
      actives: [...malangdo, 2589, 490030, 18849],
    },
    script: (character: Character2, _this: IBaseEquipment): void => {},
  },
  {
  ...
  },
  {
    ...
    canSelectOnSlot_4: {
      actives: [...malangdo, ...moraCriSlot, 18849],
    },
    script: (character: Character2, _this: IBaseEquipment): void => {},
  },
  {
  ...
  },
  {
    ...
    script: (character: Character2, _this: IBaseEquipment): void => {
      _this.fct = 0;
      if (character.costumeUpperHeadgear?.slot2?.id === 29513) {
      ...
      if (character.costumeLowerHeadgear?.slot2?.id === 29515) {
        _this.fct = 0.5;
      }
    },
  },
